...
// Варианты анимации для контейнеров
  ...
  return (
    <main className="space-y-20 sm:space-y-40 w-full">
      ...
      >
        ...
        >
          <AnimatedText
            text="Turn Clicks into Customers, and Customers into Brand Loyalist"
      ...
      >
        ...
        >
          <AnimatedText
            text="Your Getaway to Infinite Possibilities"
          ...
          {cards.map((item) => (
            ...
            >
              ...
              <motion.div
                ...
                variants={cardVariants}
              >
                <AnimatedText text={item.company_name} />
              </motion.div>
              <motion.div
      ...
      >
        ...
        >
          <AnimatedText
            text="VestraX is the proven e-commerce growth partner for Sports apparel & equipment brands ready to power past 8 figures"
      ...
      >
        ...
        >
          ...
          <motion.div className="w-full md:w-1/3" variants={containerVariants}>
            ...
            />
            <AnimatedText
              text="Strategize, Optimize, Dominate"
          ...
          {work.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                />
                <motion.p className="text-sm" variants={paragraphVariants}>
                  {item.description}
                </motion.p>
              </motion.div>
            );
        ...
        <Accordion type="single" collapsible className="w-full space-y-4">
          ...
          >
            <AccordionTrigger className="cursor-pointer text-lg font-semibold text-white transition-colors flex justify-between items-center w-full">
              <AnimatedText text="How does AI enhance marketing effectiveness?" />
          ...
          >
            <AccordionTrigger className="cursor-pointer text-lg font-semibold text-white transition-colors flex justify-between items-center w-full">
              <AnimatedText text="What sets your agency apart from the competition?" />
              <span className="accordion-arrow" />
            </AccordionTrigger>
            <AccordionContent className="text-gray-300 mt-2">
          ...
          >
            <AccordionTrigger className="cursor-pointer text-lg font-semibold text-white transition-colors flex justify-between items-center w-full">
              <AnimatedText text="When can we expect to see tangible results?" />
              <span className="accordion-arrow" />
            </AccordionTrigger>
            <AccordionContent className="text-gray-300 mt-2">
          ...
          >
            <AccordionTrigger className="cursor-pointer text-lg font-semibold text-white transition-colors flex justify-between items-center w-full">
              <AnimatedText text="Do you offer guaranteed results?" />
              <span className="accordion-arrow" />
            </AccordionTrigger>
            <AccordionContent className="text-gray-300 mt-2">
          ...
          >
            <AccordionTrigger className="cursor-pointer text-lg font-semibold text-white transition-colors flex justify-between items-center w-full">
              <AnimatedText text="What’s your pricing structure?" />
              <span className="accordion-arrow" />
            </AccordionTrigger>
            <AccordionContent className="text-gray-300 mt-2">
